...
// $image_path = '../images/raytertonlogo.jpg'; // Adjust this path according to your structure
?>
<!DOCTYPE html>
    ...
    <div class="container mx-auto p-4">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex-shrink-0">
          <img src="../images/raytertonlogo-removebg-preview.png" alt="Logo Rayterton" style="height: 40px; width: auto;"
            class="mr-2">
