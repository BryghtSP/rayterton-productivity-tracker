...
// Simpan ke database
$stmt = $pdo->prepare("INSERT INTO production_reports (user_id, report_date, job_type, title, description, status, proof_image) VALUES (?, ?, ?, ?, ?, ?, ?)");
$stmt->execute([$user_id, $report_date, $job_type, $title, $description, $status, $proof_image_path]);
